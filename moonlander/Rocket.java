...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        list1.add(ShapeMatrix.FIRE_SIDE_1);
        list1.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire=new RocketFire(list1);
        list2.add(ShapeMatrix.FIRE_SIDE_1);
        list2.add(ShapeMatrix.FIRE_SIDE_2);
        rightFire=new RocketFire(list2);
